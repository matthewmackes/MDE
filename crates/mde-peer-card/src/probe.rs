...
//!
//! This is the in-tree placeholder per PC-1's acceptance —
//! production home is `mde-mesh-types::peer_probe::PeerProbe`
//! once PC-2 lands.
    ...
    pub fn fixture() -> Self {
        Self {
            ...
            bus: BusTopology {
                ...
                usb_tree: vec![
                    "Bus 001.Port 1: Logitech MX Master 3S".into(),
                ],
            },
            kernel: KernelDriver {
                ...
                dmesg_tail: vec![
                    "wireguard: peer fixture-peer-1 added".into(),
                ],
            },
            power: PowerThermal {
                battery_pct: Some(82),
            ...
            descriptors: Descriptors {
                ...
                usb_descriptors: vec![
                    "Logitech MX Master 3S [046d:b034]".into(),
                ],
            },
        }
    }
